...
**Endpoint:** `GET https://app-bc6lra5w5on5-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-bc6lra5w5on5-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
