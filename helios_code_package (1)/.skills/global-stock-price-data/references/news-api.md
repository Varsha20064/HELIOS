...
**Endpoint:** `GET https://app-bc6lra5w5on5-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-bc6lra5w5on5-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
